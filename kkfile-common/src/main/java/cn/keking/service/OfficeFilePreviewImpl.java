...
public class OfficeFilePreviewImpl implements FilePreview {
    ...
    public List<String> supportfileTypes() {
        return List.of("xlsx", "docx", "pptx", "xls", "doc", "ppt");
    }

    public static String getPreviewType(Model model, FileAttribute fileAttribute, String officePreviewType, String pdfName, String outFilePath, FileHandlerService fileHandlerService, String officePreviewTypeImage, OtherFilePreviewImpl otherFilePreview) {
